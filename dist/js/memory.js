	...
	"timeline": [
		{
			...
			"description": "First large scale study of DRAM errors using Google's data centers. <br> <a href='https://www.cs.toronto.edu/~bianca/papers/sigmetrics09.pdf' target='_blank'><img src='http://imgur.com/mpmqk03' height='90%' width='90%'></a>",
			"icon": "fa-google",
			"impact": "high"
		},
		{
			...
			"description": "First study to look at addresses and consequently error patterns. Specifically, they were able to categorize errors and aggregate errors under single faults. <br> <a href='https://www.cs.rochester.edu/~kshen/papers/usenix2010-li.pdf' target='_blank'><img src='http://imgur.com/9Lgbeap' height='90%' width='90%'></a>",
			"icon": "fa-info-circle",
			"impact": "medium"
		},
		{
		...
		},
		{
			...
			"description": "Solidified the idea fault rates vary significantly per vendor. <br> <a href='https://www.cs.virginia.edu/~gurumurthi/papers/SC13.pdf' target='_blank'><img src='http://imgur.com/v0ndhDS' height='90%' width='90%'></a>",
			"icon": "fa-superpowers",
			"impact": "low"
		},
		{
			...
			"description": "Demonstrated the effectiveness of x8 Chipkill as a memory correction technology. <br> <a href='http://dl.acm.org/citation.cfm?id=2671853.2672356' target='_blank'><img src='http://imgur.com/19HgXdo' height='90%' width='90%'></a>",
			"icon": "fa-superpowers",
			"impact": "medium"
		},
		{
