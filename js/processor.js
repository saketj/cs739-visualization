var PROCESSOR = {
	...
	"timeline": [
		...
		},
		{
			...
			"description": "Proposed an adaptive framework to monitor health overtime and predict failures. This could be used with a fluid approach to core allocation. <br> <a href='https://www.eecs.umich.edu/cse/awards/pdfs/iccd09.pdf' target='_blank'><img src='http://imgur.com/ZayALXa' height='90%' width='90%'></a>",
			"icon": "fa-flash",
			"impact": "low"
		},
		{
		...
		},
		{
			...
			"description": "Identified the main contributors to faults. <br> <a href='https://www.cs.virginia.edu/~gurumurthi/papers/asplos15.pdf' target='_blank'><img src='http://imgur.com/65COgqJ' height='90%' width='90%'></a>",
			"icon": "fa-flash",
			"impact": "high"
		}
	]
